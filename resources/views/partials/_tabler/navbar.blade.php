    ...
    <div class="row align-items-center">
      ...
      <div class="col-lg order-lg-first">
        <ul class="nav nav-tabs border-0 flex-column flex-lg-row">
          ...
          <li class="nav-item">
            <a href="{{ route('projects') }}" class="nav-link"><i class="fe fe-box"></i> Projects</a>
          </li>
          <li class="nav-item">
          ...
          <li class="nav-item dropdown">
            <a href="javascript:void(0)" class="nav-link" data-toggle="dropdown"><i class="fe fe-check-square"></i> HR</a>
            <div class="dropdown-menu dropdown-menu-arrow">
